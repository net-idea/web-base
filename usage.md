...
If the bundle is in your project under `vendor/net-idea/web-base/`:
...
2. Check path exists: `vendor/net-idea/web-base/frontend/`
...
1. **Never modify files in `vendor/net-idea/web-base/`** unless explicitly asked
